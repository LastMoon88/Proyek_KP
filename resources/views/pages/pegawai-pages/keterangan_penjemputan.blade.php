      ...
      <div class="card-body">
        ...
        <div class="col-lg-12 mx-auto">
            <div class="auto-form-wrapper">
                <form action="{{ url('/update_status_pickup')}}" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control" placeholder="Kode Ban" name="kodeban" style="width: 60pt; height: 20px;  padding: 0.375rem 0.75rem; " />
                        </div>
                    </div>
                    <br>
