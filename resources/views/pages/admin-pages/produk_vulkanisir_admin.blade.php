            ...
            <div class="auto-form-wrapper">
                <form action="{{ url('/add_produk_vulkanisir')}}" method="post">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control" placeholder="tread" name="tread" style="width: 50pt; height: 20px;  padding: 0.375rem 0.75rem; " />
                        </div>
                    </div>
                    <br>
                    <div class="control-group">
            ...
            <tbody>
              @foreach ($DaftarProdukVulkanisir as $produkVulk)
                <tr>
                    ...
                    <td class="text-center">
                        <button type="button" class="btn btn-inverse-danger btn-rounded btn-fw"><a style="text-decoration: none;" class="text-danger" href="to_delete_produk_vulkanisir/{{$produkVulk->Id_produk_vulkanisir}}">Delete</a></button>
                    </td>
                </tr>
              @endforeach
            </tbody>
